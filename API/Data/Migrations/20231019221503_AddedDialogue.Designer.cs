...
namespace API.Data.migrations
{
    ...
    [Migration("20231019221503_AddedDialogue")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Armor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ArmorCollection");
                });

            modelBuilder.Entity("API.Boots", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API.HandItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("HandItemCollection");
                });

            modelBuilder.Entity("API.Helmet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API.Entities.Adventure.LocationLink", b =>
                {
                    ...
                    b.HasOne("API.Entities.Adventure.Location", "ToLocation")
            ...
            modelBuilder.Entity("API.PlayerCharacter", b =>
                {
                    ...
                    b.HasOne("API.Armor", "Body")
                        .WithMany()
                        .HasForeignKey("BodyId");

                    b.HasOne("API.Boots", "Feet")
                        .WithMany()
                        .HasForeignKey("FeetId");

                    b.HasOne("API.Helmet", "Helmet")
                        .WithMany()
                        .HasForeignKey("HelmetId");

                    b.HasOne("API.HandItem", "LeftHand")
                        .WithMany()
                        .HasForeignKey("LeftHandId");

                    b.HasOne("API.HandItem", "RightHand")
                        .WithMany()
